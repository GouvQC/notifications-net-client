...
namespace PgnNotifications.Client.Tests.IntegrationTests
{
    ...
    public class NotificationClientIntegrationTests
    {
        ...
        public void SendSmsTestWithPersonalisation()
        {
            ...
            var response = clientObj.SendSms(
        ...
        public void SendEmailTestWithPersonalisation()
        {
            ...
            var response = clientObj.SendEmail(
                Constants.fakeEmail,
                Constants.fakeTemplateId,
                personalisation,
                null,
        ...
        public void SendBulkNotificationsWithRows_WorksAsExpected()
        {
            ...
            var response = clientObj.SendBulkNotifications(
        ...
        public void GetAllNotifications()
        {
            ...
            var notificationsResponse = clientObj.GetNotifications();
        ...
        public void GetNotificationWithInvalidIdRaisesClientException()
        {
            ...
            var ex = Assert.Throws<NotifyClientException>(() =>
                clientObj.GetNotificationById("fa5f0a6e-5293-49f1-b99f-3fade784382f")
            );
        ...
        public void GetTemplateWithInvalidIdRaisesClientException()
        {
            ...
            var ex = Assert.Throws<NotifyClientException>(() =>
                clientObj.GetTemplateById("id is not a valid UUID")
            );
        ...
        public void GetTemplateWithIdWithoutResultRaisesClientException()
        {
            ...
            var ex = Assert.Throws<NotifyClientException>(() =>
                clientObj.GetTemplateById("fa5f0a6e-5293-49f1-b99f-3fade784382f")
            );
            Assert.That(ex!.Message, Does.Contain("No result found"));
        }
        ...
        public void GetAllTemplates()
        {
            ...
            TemplateList templateList = clientObj.GetAllTemplates();
        ...
        public void GetAllSMSTemplates()
        {
            ...
            TemplateList templateList = clientObj.GetAllTemplates(type);
            Assert.IsNotNull(templateList);
            Assert.AreNotEqual(templateList.templates.Count, 0);
        ...
        public void GetSMSTemplateWithId()
        {
            ...
            TemplateResponse template = clientObj.GetTemplateById(Constants.fakeTemplateId);
        ...
        public void GenerateSMSPreviewWithPersonalisation()
        {
            ...
            TemplatePreviewResponse response = clientObj.GenerateTemplatePreview(Constants.fakeTemplateId, personalisation);
        ...
        public void SendSms_RespectsCustomHttpClientTimeout()
        {
            ...
            var client = NotificationClientBuilder.Create()
                ...
                .WithClientId(Constants.fakeClientId)
                .WithBaseUrl("https://fake-api.test")
                .WithHandlerBuilder(hb => hb.WithTestHandler(new TimeoutHandler(5000)))
                .WithTimeout(TimeSpan.FromMilliseconds(100))
                .Build();

            // On s'assure que l'exception levée est bien un AggregateException contenant un TaskCanceledException
