...
namespace PgnNotifications.Interfaces
{
    public interface INotificationClient : IBaseClient
    {
        ...
        SmsNotificationResponse SendSms(string mobileNumber, string templateId, Dictionary<string, dynamic> personalisation = null, string reference = null, string smsSenderId = null);

        EmailNotificationResponse SendEmail(string emailAddress, string templateId, Dictionary<string, dynamic> personalisation = null, string reference = null, string emailReplyToId = null, string oneClickUnsubscribeURL = null, string scheduledFor = null, string importance= null, string ccAddress = null);

        HttpResponseMessage SendBulkNotifications(string templateId, string name, List<List<string>> rows = null, string csv = null,
                                                         string reference = null, string scheduledFor = null, string emailReplyToId = null);
    }
}